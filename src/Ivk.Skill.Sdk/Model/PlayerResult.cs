...
namespace Ivk.Skill.Sdk.Model
{
    ...
    /// PlayerResult
    /// </summary>
    [DataContract(Name = "PlayerResult")]
    public partial class PlayerResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerResult" /> class.
        /// </summary>
        ...
        /// <param name="playerIdx">Zero-indexed player index (required).</param>
        ...
        public PlayerResult(PlayerUpdateExtended extended = default(PlayerUpdateExtended), string playerId = default(string), int playerIdx = default(int), PriorPlayerStats post = default(PriorPlayerStats), PriorPlayerStats prior = default(PriorPlayerStats))
        {
